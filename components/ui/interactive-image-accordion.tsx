    ...
    >
      ...
      <span
        className={[
          ...
          isActive
            ? "bottom-5 left-1/2 max-w-[90%] -translate-x-1/2 rotate-0 text-center font-mono text-sm font-normal uppercase leading-snug tracking-[0.12em] sm:bottom-6 sm:text-base"
            : "bottom-24 left-1/2 w-max max-w-none -translate-x-1/2 rotate-90 whitespace-nowrap font-mono text-[10px] font-normal uppercase leading-none tracking-[0.16em] sm:text-[11px]",
    ...
    <div className="w-full">
      <div className="flex flex-col items-stretch gap-10 md:flex-row md:items-center md:justify-between md:gap-12 lg:gap-16">
        <div className="w-full text-center md:w-[42%] md:max-w-xl md:text-left">
          {headline ? (
            <h3 className="font-display text-[clamp(1.75rem,4vw,3rem)] font-medium uppercase leading-tight tracking-[-0.03em] text-white">
